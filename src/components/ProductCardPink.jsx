    ...
    >
      ...
      >
        ...
        <div className="flex flex-col md:grid md:grid-cols-5">
          ...
          <div className="p-6 overflow-y-auto max-h-[70vh] pr-2 md:col-span-3 order-2 md:order-1">
            ...
            <div className="mb-4 grid grid-cols-[auto,1fr] gap-x-3 gap-y-1 text-xs text-slate-600">
              ...
              <div>{(descricao_ingredientes || ingredientes || '').trim() ? (descricao_ingredientes || ingredientes) : 'Não sei'}</div>
              <div className="font-medium text-slate-700">Alérgicos:</div>
              <div>{(alergicos || '').trim() ? alergicos : 'Não sei'}</div>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4">
                ...
                <AttributeRow icon={ATTR_ICONS.leite_ou_derivados} name="Pode conter leite" value={atributos.pode_conter_leite_ou_derivados ? 'Sim' : 'Não'} type={atributos.pode_conter_leite_ou_derivados ? 'traces' : 'free'} />
                ...
                <AttributeRow icon={ATTR_ICONS.contem_ovos} name="Pode conter ovos" value={atributos.pode_conter_ovos ? 'Sim' : 'Não'} type={atributos.pode_conter_ovos ? 'traces' : 'free'} />
                ...
                <AttributeRow icon={ATTR_ICONS.contem_carne} name="Pode conter carne" value={atributos.pode_conter_carne ? 'Sim' : 'Não'} type={atributos.pode_conter_carne ? 'traces' : 'free'} />
                ...
                <AttributeRow icon={ATTR_ICONS.contem_gluten} name="Pode conter glúten" value={atributos.pode_conter_gluten ? 'Sim' : 'Não'} type={atributos.pode_conter_gluten ? 'traces' : 'free'} />
                ...
                <AttributeRow icon={ATTR_ICONS.contem_soja} name="Pode conter soja" value={atributos.pode_conter_soja ? 'Sim' : 'Não'} type={atributos.pode_conter_soja ? 'traces' : 'free'} />
                ...
                <AttributeRow icon={ATTR_ICONS.contem_amendoim} name="Pode conter amendoim" value={atributos.pode_conter_amendoim ? 'Sim' : 'Não'} type={atributos.pode_conter_amendoim ? 'traces' : 'free'} />
                ...
                <AttributeRow icon={ATTR_ICONS.contem_castanhas} name="Pode conter castanhas" value={atributos.pode_conter_castanhas ? 'Sim' : 'Não'} type={atributos.pode_conter_castanhas ? 'traces' : 'free'} />
                ...
                <AttributeRow icon={ATTR_ICONS.contem_peixe} name="Pode conter peixe" value={atributos.pode_conter_peixe ? 'Sim' : 'Não'} type={atributos.pode_conter_peixe ? 'traces' : 'free'} />
                ...
                <AttributeRow icon={ATTR_ICONS.contem_crustaceos} name="Pode conter crustáceos" value={atributos.pode_conter_crustaceos ? 'Sim' : 'Não'} type={atributos.pode_conter_crustaceos ? 'traces' : 'free'} />
                ...
                <AttributeRow icon={ATTR_ICONS.origem_animal} name="Pode conter origem animal" value={atributos.pode_conter_origem_animal ? 'Sim' : 'Não'} type={atributos.pode_conter_origem_animal ? 'traces' : 'free'} />
              </div>
            </div>
          ...
          <div className="bg-slate-50 p-5 flex items-start justify-center border-t md:border-t-0 md:border-l md:col-span-2 order-1 md:order-2">
            <img src={imagem} alt={nome} className="w-full max-w-[240px] h-48 md:h-60 object-contain rounded-xl shadow-sm" />
          </div>
        </div>
      </div>
    </div>
